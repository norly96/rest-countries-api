...
const CountryItem = ({ country }: Props):JSX.Element => {
  return (
    <div key={country.cca2} className="flex flex-col mb-10  bg-element-light dark:bg-element-dark overflow-hidden max-w-sm rounded-lg shadow-sm shadow-primary-light text-primary-light dark:text-primary-dark">
