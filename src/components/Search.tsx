...
const Search = () => {
  return (
    <div className='flex flex-row mb-8 sm:mb-0 items-center w-80 shadow-sm shadow-primary-light bg-element-light dark:bg-element-dark text-primary-light dark:text-primary-dark  text-xs sm:text-sm font-nunito rounded-lg py-4 px-5'>
            ...
            <input type="text" className="ml-3 rounded-lg placeholder:text-gray dark:placeholder:text-primary-dark focus:outline-none bg-element-light dark:bg-element-dark text-gray dark:text-primary-dark" placeholder="Search for a country"/>
    </div>
  )
}
